 ...
 * It also contains static factory methods to create the various node types.
 * 
...
public abstract class Expression {
   ...
   * @param resultType The {@link Class} to set as the type of the expression that this Expression
   *        represents.
   */
  ...
  /**
   * Creates a {@link BinaryExpression} that represents an arithmetic addition operation that does not
   ...
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to Add and
   *         the getFirst() and getSecond() methods set to the specified values.
   */
   ...
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to Divide
   *         and the getFirst() and getSecond() methods set to the specified values.
   */
   ...
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to Subtract
   *         and the getFirst() and getSecond() methods set to the specified values.
   */
   ...
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to Multiply
   *         and the getFirst() and getSecond() methods set to the specified values.
   */
   ...
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to Modulo
   *         and the getFirst() and getSecond() methods set to the specified values.
   */
   ...
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to
   *         GreaterThan and the getFirst() and getSecond() methods set to the specified values.
   */
   ...
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to
   *         GreaterThanOrEqual and the getFirst() and getSecond() methods set to the specified
   *         values.
   */
   ...
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to LessThan
   *         and the getFirst() and getSecond() methods set to the specified values.
   */
   ...
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to
   *         LessThanOrEqual and the getFirst() and getSecond() methods set to the specified values.
   */
   ...
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to
   *         LeftShift and the getFirst() and getSecond() methods set to the specified values.
   */
   ...
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to
   *         RightShift and the getFirst() and getSecond() methods set to the specified values.
   */
   ...
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to Coalesce
   *         and the getFirst() and getSecond() methods set to the specified values.
   */
  ...
  /**
   * Creates a {@link Expression} that represents an equality comparison. The expression will be
   * simplified if one of parameters is constant {@link Boolean}.
   * 
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} method equal to Equal and
   *         the getFirst() and getSecond() methods set to the specified values, or one of the
   *         parameters if they one of them is constant {@link Boolean}.
   */
  ...
  /**
   * Creates a {@link Expression} that represents an inequality comparison. The expression will be
   * simplified if one of parameters is constant {@link Boolean}.
   * 
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
  ...
  /**
   * Creates a {@link Expression} that represents a conditional AND operation that evaluates the
   * second operand only if it has to. The expression will be simplified if one of parameters is
   * constant.
   * 
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} method equal to LogicalAnd
   *         and the getFirst() and getSecond() methods set to the specified values, or one of the
   *         parameters if they one of them is constant.
   */
   ...
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} method equal to BitwiseAnd
   *         and the getFirst() and getSecond() properties set to the specified values.
   */
  ...
  /**
   * Creates a {@link Expression} that represents a conditional OR operation that evaluates the second
   * operand only if it has to. The expression will be simplified if one of parameters is constant.
   * 
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} method equal to LogicalOr
   *         and the getFirst() and getSecond() methods set to the specified values, or one of the
   *         parameters if they one of them is constant.
   */
   ...
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} method equal to BitwiseOr
   *         and the getFirst() and getSecond() properties set to the specified values.
   */
  ...
  /**
   * Creates a {@link BinaryExpression} that represents a bitwise XOR operation, or
   * {@link UnaryExpression} that represents a bitwise NOT in case the second parameter equals to -1.
   * 
   * @param first An {@link Expression} to set the getFirst() method equal to.
   * @param second An {@link Expression} to set the getSecond() method equal to.
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} method equal to
   *         ExclusiveOr and the getFirst() and getSecond() properties set to the specified values, or
   *         {@link UnaryExpression} that represents a bitwise NOT in case the second parameter equals
   *         to -1.
   */
   ...
   * @return A {@link UnaryExpression} that has the {@link ExpressionType} property equal to
   *         ArrayLength and the getFirst() method set to array.
   */
   ...
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} method equal to ArrayIndex
   *         and the getFirst() and getSecond() methods set to the specified values.
   */
  ...
  /**
   * Creates a {@link UnaryExpression} that represents a conversion operation, or 'e' if its
   * ResultType equals to 'to'.
   * 
   ...
   * @return A {@link UnaryExpression} that has the {@link ExpressionType} property equal to Convert,
   *         or 'e'.
   */
   ...
   * and resultType is assignable from its type.
   * 
   * @param value An Object to set the getValue() method equal to.
   * @param resultType The {@link Class} to set as the type of the expression that this Expression
   *        represents.
   * @return A {@link ConstantExpression} that has the {@link ExpressionType} property equal to
   *         Constant and the getValue() method set to the specified value.
   */
  ...
  /**
   * Creates a {@link UnaryExpression} that represents an expression that has a constant value of type
   * {@link Expression}.
   * 
   * @param e An {@link Expression} to set the {@code getFirst()} method equal to.
   * @return A {@link UnaryExpression} that has the {@link ExpressionType} property equal to Quote and
   *         the {@code getFirst()} method set to the specified value.
   */
   ...
   * @return A {@link UnaryExpression} that has the {@link ExpressionType} property equal to Negate
   *         and the getValue() method set to the specified value.
   */
   ...
   * @return A {@link ParameterExpression} that has the getExpressionType() method equal to Parameter
   *         and the getResultType() and getIndex() methods set to the specified values.
   */
   ...
   * @return A {@link BinaryExpression} that has the getExpressionType() equal to InstanceOf, the
   *         getFirst() set to 'e' and getSecond() set to {@link ConstantExpression} with value equals
   *         to 'type'.
   */
  ...
  /**
   * Creates a {@link Expression}, given an operand and unary operator, by calling the appropriate
   * factory method.
   * 
   * @param expressionType The {@link ExpressionType} that specifies the type of unary operation.
   * @param resultType The {@link Class} that specifies the type to be converted to (pass null if not
   *        applicable).
  ...
  /**
   * Creates a {@link Expression}, given an operand and binary operator, by calling the appropriate
   * factory method.
   * 
  ...
  /**
   * Creates a {@link LambdaExpression} as a method receiving the specified {@code arguments},
   * returning the {@code resultType} and having {@code body} for its implementation.
   * 
   * @param resultType The method return value.
   * @param body The method implementation.
   * @param arguments The method arguments.
   * @return A {@link LambdaExpression} as a method receiving the specified {@code arguments},
   *         returning the {@code resultType} and having {@code body} for its implementation.
   */
  ...
  /**
   * Creates a {@link InvocationExpression} that represents accessing a static field given the name of
   * the field.
   * 
   * @param type The {@link Class} that specifies the type that contains the specified static field.
   * @param name The name of a field.
   * @return A {@link InvocationExpression} that represents accessing a static field given the name of
   *         the field.
  ...
  /**
   * Creates a {@link InvocationExpression} that represents accessing an instance field given the name
   * of the field.
   * 
   * @param instance An {@link Expression} whose {@code getResultType()} value will be searched for a
   *        specific field.
   * @param name The name of a field.
   * @return A {@link InvocationExpression} that represents accessing an instance field given the name
   *         of the field.
   * @throws NoSuchFieldException if a field with the specified name is not found.
   */
  ...
  /**
   * Creates an {@link InvocationExpression} that represents a call to an instance method, or
   * {@link UnaryExpression} in case of boxing.
   * 
   * @param instance An {@link Expression} whose {@code getResultType()} value will be searched for a
   *        specific method.
   * @param method The {@link Method} to be called.
   * @param arguments An array of {@link Expression} objects that represent the arguments to the
   *        method.
   * @return An {@link InvocationExpression} that has the {@link ExpressionType} method equal to
   *         Invoke or Convert in case of boxing.
   */
  ...
  /**
   * Creates an {@link InvocationExpression} that represents a call to an instance method by calling
   * the appropriate factory method, or {@link UnaryExpression} in case of boxing.
   * 
   * @param instance An {@link Expression} whose {@code getResultType()} value will be searched for a
   *        specific method.
   * @param name The name of the method.
   * @param parameterTypes An array of {@link Class} objects that specify the type of parameters of
   *        the method.
   * @param arguments An array of {@link Expression} objects that represent the arguments to the
   *        method.
   * @return An {@link InvocationExpression} that has the {@link ExpressionType} method equal to
   ...
   * @throws NoSuchMethodException if a matching method is not found.
   */
  public static Expression invoke(Expression instance, String name, Class<?>[] parameterTypes, Expression... arguments)
      throws NoSuchMethodException {
    return invoke(instance, getDeclaredMethod(instance.getResultType(), name, parameterTypes), arguments);
  }

  /**
   * Creates an {@link InvocationExpression} that represents a call to a static method by calling the
   * appropriate factory method, or {@link UnaryExpression} in case of boxing.
   * 
  ...
  private static Method getDeclaredMethod(Class<?> clazz, String name, Class<?>[] parameterTypes) throws NoSuchMethodException {
    ...
    Stack<Class<?>> interfacesStack = null;
    for (;;) {
      try {
        return tmpClass.getMethod(name, parameterTypes); // << S&B FIX: replaced getDeclaredMethod otherwise it
                                                         // does not see methods from inherited interfaces.
                                                         // Other solution would be to change the no such
                                                         // method exception handling, by calling
                                                         // getIntefaces() and introspect each >>//
      } catch (NoSuchMethodException e) {
  ...
  /**
   * Creates a {@link BinaryExpression} that represents a conditional operation, or one of operands in
   * case test is a constant.
   * 
   ...
   * @return A {@link BinaryExpression} that has the {@link ExpressionType} property equal to
   *         Conditional and the getFirst() and getSecond() methods set to the specified values.
   */
  ...
  /**
   * Dispatches to the specific visit method for this node type. For example, {@link BinaryExpression}
   * calls the {@link ExpressionVisitor#visit(BinaryExpression)}.
   * 
